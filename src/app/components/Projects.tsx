...
export function Projects() {
  const projects = [
    ...
    {
      title: 'ClarityAI Engine — AI DB Analyst',
      label: '🤖 AI Database Analyst',
      description: 'A conversational BI interface powered by LangGraph and Sarvam AI (sarvam-30b). Cleans and imports spreadsheets to PostgreSQL, translating natural language queries to SQL and streaming insights with interactive Apache ECharts visualizations under strict read-only executive guardrails.',
      color: 'bg-orange-400',
      tags: ['LangGraph', 'Sarvam AI', 'PostgreSQL', 'Flask', 'Apache ECharts'],
      github: null,
    },
    {
      title: 'Supply Chain Saathi — WhatsApp B2B',
      label: '💬 WhatsApp B2B',
      description: 'A WhatsApp-native reverse auction procurement agent for Indian wholesale retailers built for the Cognizant Technoverse 2026 hackathon. Uses FastAPI, LangGraph, Gemini 2.5 Flash, and MongoDB geospatial queries to find and quote top wholesaler pricing in real-time.',
      color: 'bg-emerald-400',
      tags: ['FastAPI', 'LangGraph', 'Gemini Flash', 'MongoDB', 'WhatsApp'],
      github: null,
    },
    {
